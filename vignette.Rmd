...
invisible(dev.off())
```
![Figure X: Heat map of most significant genes](results_DGE/heatmap.jpeg)
Though these genes show distinct patterns of expression in the different conditions, there are cases in which there may be, for instance, underexpression in affected and unaffected individuals: this is because their genetic background is shared and may be similar though one of them does develop the disease but not the other.
